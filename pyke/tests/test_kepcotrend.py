...
def test_kepcotrend(fitmethod):
    kepcotrend(lc, cbv, '1 2 3', outfile="kepcotrend.fits", fitmethod=fitmethod)
    f = pyfits.open("kepcotrend.fits")
    lc_cot = get_pkg_data_filename("data/kplr005110407-2009350155506_llc-kepcotrend-{}.fits".format(fitmethod))
