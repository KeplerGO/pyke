...
def kepbls(infile, outfile, datacol, errcol, minper, maxper, mindur, maxdur,
    ...
    call = ('KEPBLS -- '
            ...
            + ' datacol= {}'.format(str(datacol))
            + ' errcol= {}'.format(str(errcol))
            + ' minper= {}'.format(str(minper))
            + ' maxper= {}'.format(str(maxper))
            + ' mindur= {}'.format(str(mindur))
            + ' maxdur= {}'.format(str(maxdur))
            + ' nsearch= {}'.format(str(nsearch))
            + ' nbins= {}'.format(str(nbins))
            + ' plot= {}'.format(str(plot))
            + ' clobber= {}'.format(str(clobber))
